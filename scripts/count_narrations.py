#!/usr/bin/env python3
"""Count non-empty scene narration lines in a scripts JSON file."""
...
def count_narrations(payload: Any) -> int:
...
def main(argv: list[str] | None = None) -> int:
    ...
    total = count_narrations(load_scripts(args.scripts_file))
    json.dump({"narration_count": total}, sys.stdout)
    sys.stdout.write("\n")
    return 0
