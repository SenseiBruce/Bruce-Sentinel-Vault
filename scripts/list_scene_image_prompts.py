#!/usr/bin/env python3
"""List scene image prompts from a scripts JSON file."""
...
def list_scene_image_prompts(payload: Any) -> list[str]:
...
def main(argv: list[str] | None = None) -> int:
    ...
    lines = list_scene_image_prompts(load_scripts(args.scripts_file))
    json.dump({"count": len(lines), "image_prompts": lines}, sys.stdout)
    sys.stdout.write("\n")
    return 0
