#!/usr/bin/env python3
"""Count scene image prompts in a scripts JSON file."""
...
def count_image_prompts(payload: Any) -> int:
...
def main(argv: list[str] | None = None) -> int:
    ...
    total = count_image_prompts(load_scripts(args.scripts_file))
    json.dump({"total_image_prompts": total}, sys.stdout)
    sys.stdout.write("\n")
    return 0
